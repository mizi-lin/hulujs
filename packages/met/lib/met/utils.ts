 ...
 */
export function removeTwiceComment(element: HTMLElement) {
    try {
        // 获取父元素
        ...
        for (const node of nodes) {
            ...
            const isTwice =
                ...
                (node as HTMLElement).nextSibling?.nodeType === Node.COMMENT_NODE;
 ...
 * @param comment 注释内容
 */
export function insertComment(element: HTMLElement, comment: string) {
