 ...
 */
const transformUrlSearchParams = function (url: string, search: Record<string, any>) {
 ...
 */
const cancelStore = {};
const cancelRequestSignal = function (
...
export const Request = function (
    ...
    run(() => {
        ...
        // 处理值为undefined的属性
        config.headers = compact(config.headers, 'undefined') as Record<string, any>;
...
export const Ruyi = function (url: string, ruyiOptions: RuyiOptions = {}) {
    return {
        __url: url,
        /**
         ...
         * GET请求在浏览器中有长度限制
         */
        get: (search?: Record<string, any>, options: RuyiOptions = {}) => {
         ...
         */
        post: (payload?: Record<string, any>, options: RuyiOptions = {}) => {
         ...
         */
        delete: (search?: Record<string, any>, options: RuyiOptions = {}) => {
         ...
         */
        head: (search?: Record<string, any>, options: RuyiOptions = {}) => {
         ...
         */
        down: (search: Record<string, any>, options: RuyiOptions = {}) => {
         ...
         * 上传文件
         */
        upload: (form, search?: Record<string, any>, options: RuyiOptions = {}) => {
            options.headers ??= {};
