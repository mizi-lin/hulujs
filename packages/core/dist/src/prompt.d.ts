import { PromptsCancel, PromptsCancelOptions, PromptsConfirmOptions, PromptsMultiSelectOptions, PromptsSelectOption, PromptsSelectOptions, PromptsTextOptions } from '@hulujs/types';
